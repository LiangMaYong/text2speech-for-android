...
public class Text2Speech {
    ...
    public static final String ACTION_TEXT2SPEECH = "com.liangmayong.text2speech.action";
    ...
    public static final String TAG = "Text2Speech";
    ...
    private static OnText2SpeechListener defListener = new OnText2SpeechListener() {
        ...
        public void onLoadProgress(int progressLenght, int lenght) {
            if (DEBUG)
                Log.d(TAG, "onLoadProgress:" + progressLenght + "/" + lenght);
            if (!isListener) {
                return;
            }
            if (listeners != null && !listeners.isEmpty()) {
        ...
        public void onPlayProgress(int currentPosition, int duration) {
            if (DEBUG)
                Log.d(TAG, "onPlayProgress:" + currentPosition + "/" + duration);
            if (!isListener) {
                return;
            }
            if (listeners != null && !listeners.isEmpty()) {
    ...
    /**
     * setOnText2SpeechListener
     *
     * @param ttsListener ttsListener
     */
    public static void setOnText2SpeechListener(OnText2SpeechListener ttsListener) {
